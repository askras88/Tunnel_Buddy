...
IMAGE_PATH = "https://freeimage.host/i/dalle-2024-10-04-1649.dbPhDcQ"  # Укажите здесь путь к изображению
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if update.message:
        ...
        await update.message.reply_photo(
            photo=IMAGE_PATH,
            caption=("С Tunnel Buddy ты можешь смотреть видео в высоком разрешении и не париться о скорости! 🚀 "
